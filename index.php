...
<head>
    <meta charset="utf-8" />
    <title>JARA AIRWAYS - THE BEST GLOBAL AIRLINE</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <img src="img/logo.png" alt="jaraairways" height="100">
        </a>
    ...
    <section id="hero">
        <video autoplay loop muted>
            <source src="./video/airplanestock.mp4" type="video/mp4">
        </video>

        <div class="hero-content">
            <div class="form-container">
                <p class="title">Reserva un vuelo</p>
                <form class="regForm" method="POST" action="./php/vueloConfirm.php" id="vueloform" name="vueloform">
        <div class="tab">
            <div class="form-row">
                <div class="form-column">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="fecha-ida" id="fecha-ida">
                    </div>
                </div>
                <div class="form-column">
                    <div class="input-group">
                        <label for="claseCabina">Clase de cabina</label>
                        <select name="claseCabina" id="claseCabina">
                            <option value="" disabled selected hidden>-</option>
                            <option value="Turista">Turista</option>
                            <option value="TuristaSuperior">Turista Superior</option>
                            <option value="Business">Business</option>
                            <option value="Primera">Primera</option>
                        </select>
                    </div>
                    <div class="input-group">
                        <label for="franjaEdad">Franja de edad</label>
                        <select name="franjaEdad" id="franjaEdad">
                            <option value="" disabled selected hidden>-</option>
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="fecha-vuelta" id="fecha-vuelta">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="overflow:auto;">
            <div style="float:right;">
                <button type="button" class="btnNext" id="prevBtn" onclick="nextPrev(-1)">Previous</button>
    ...
    <!-- Reserva End -->
    <br>
    <!-- Vuelos populares Start -->

    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.01s">
                <h1 class="mb-5">Destinos populares</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.01s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/barcelona.jpg" alt="Remind command">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Barcelona</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.04s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/amsterdam.jpg" alt="Study command">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Amsterdam</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.07s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/paris.jpg" alt="Ban command">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">París</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.10s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/milan.jpg" alt="Rules command">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Milán</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.13s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/roma.jpg" alt="FAQ command">
                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Roma</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.16s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/bruselas.jpeg" alt="Help command">

                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Bruselas</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.19s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/ibiza.jpg" alt="Wiki command">

                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Ibiza</h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.21s">
                    <div class="team-item">
                        <div class="position-relative overflow-hidden">
                            <img class="img-fluid" src="./img/budapest.jpg" alt="Wiki command">

                        </div>
                        <div class="bg-light text-center p-4">
                            <h5 class="fw-bold mb-0">Budapest</h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>admin@jaraairways.com</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <p>&copy; 2024 JARA AIRWAYS - All rights reserved - <a href="./privacy-policy.php">Privacy
                                Policy</a></p>
                    </div>
